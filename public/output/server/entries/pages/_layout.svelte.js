...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_page();
  return ` ${showCookieModal && cookieEnabled ? `<div class="cookieContainer svelte-1uycidv"><p class="svelte-1uycidv" data-svelte-h="svelte-1iwts5v">🍪 This website use <a href="privacy-policy" class="svelte-1uycidv">Cookies.</a></p> <div role="button" tabindex="0" class="svelte-1uycidv" data-svelte-h="svelte-1bl8vgs">✕</div></div>` : ``} ${validate_component(NavBar, "Navbar").$$render($$result, { segment: $page.url.pathname }, {}, {})} ${slots.default ? slots.default({}) : ``} <footer class="svelte-1uycidv" data-svelte-h="svelte-1m4le4p"></footer>`;
});
export {
  Layout as default
};
